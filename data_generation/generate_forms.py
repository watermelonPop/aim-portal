...
def generate_forms(file_directory):
    ...
    end_date_2025 = date(today.year, 12, 31)
    ...
    for name in names.keys():
        ...
        for i in names[name]: 
            ...
            form_due_date = fake.date_between(start_date=start_date, end_date=today) if form_status in ["Submitted", "Approved", "Rejected"] else fake.date_between(start_date=today, end_date=end_date_2025)
